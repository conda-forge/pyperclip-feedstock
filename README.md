About pyperclip-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyperclip-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4119&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyperclip-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyperclip` can be installed with `conda`:
...
```
mamba install pyperclip
```

It is possible to list all of the versions of `pyperclip` available on your platform with `conda`:
...
```
mamba search pyperclip --channel conda-forge
```
...
mamba repoquery search pyperclip --channel conda-forge

# List packages depending on `pyperclip`:
mamba repoquery whoneeds pyperclip --channel conda-forge

# List dependencies of `pyperclip`:
mamba repoquery depends pyperclip --channel conda-forge
```
